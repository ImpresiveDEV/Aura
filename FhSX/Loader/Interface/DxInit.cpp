...
LRESULT WINAPI DxInit::WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
bool DxInit::CreateDeviceD3D(HWND hWnd)
{
...
void DxInit::CleanupDeviceD3D()
{
    if (g_pd3dDevice) { g_pd3dDevice->Release(); g_pd3dDevice = NULL; }
    if (g_pD3D) { g_pD3D->Release(); g_pD3D = NULL; }
}

void DxInit::ResetDevice()
{
